...
struct BLUEPRINTASSIST_API FBAUtils
{
	...
	static bool DoesPinTypeCategoryObjectMatchName(const UEdGraphPin* Pin, const FString& StructName);
	...
	static bool HasMetaDataChanged(const FBAVariableDescription& OldVariable, const FBAVariableDescription& NewVariable, const FName Key);
	...
	static FString GetVariableName(const FString& Name, const FName& PinCategory);
};